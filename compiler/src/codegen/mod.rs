...
impl<T: Tag> Instruction<T> {
    pub fn is_pure(&self) -> bool {
        match self {
            ...
            Instruction::MakeAtom(_) => Make::<T, FunctionId<T>>::is_pure(),
    ...
    fn declared_register(&self) -> Option<RegisterId<T>> {
        match self {
            ...
            Instruction::MakeAtom(i) => i.declared_register(),
    ...
    fn used_registers(&self) -> TinyVec<[RegisterId<T>; 3]> {
        match self {
            ...
            Instruction::MakeAtom(i) => i.used_registers(),
    ...
    fn used_registers_mut(&mut self) -> Vec<&mut RegisterId<T>> {
        match self {
            ...
            Instruction::MakeAtom(i) => i.used_registers_mut(),
    ...
    fn display(&self, w: &mut impl Write) -> std::fmt::Result {
        match self {
            ...
            Instruction::MakeAtom(i) => i.display(w),
